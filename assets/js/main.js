...
//       autoplayHoverPause: true,
//       smartSpeed: 1000 // Speed of sliding animation
//     });

//     // Smooth scrolling to Work Experience section
...
$(document).ready(function(){
  ...
  $("#testimonial-mf").owlCarousel({
    ...
    loop: true,
    autoplay: true,
    autoplayTimeout: 5000, // Reduced to 5 seconds
    autoplayHoverPause: true,
    smartSpeed: 1000 // Speed of sliding animation
  });
  ...
  $("#scrollToWork").click(function() {
    $('html, body').animate({
      ...
      // Restart autoplay after scrolling animation completes
      $("#testimonial-mf").trigger('play.owl.autoplay');
    });
  });
});
